...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638365470
...
cp %{_builddir}/parso-0.8.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/parso/b1a7c6c0bf49fd5b62cca57a802166f291273c9a
cp %{_builddir}/parso-0.8.3/docs/_themes/flask/LICENSE %{buildroot}/usr/share/package-licenses/parso/d0eff60551064b040266867c393e035d747b0ae5
cp %{_builddir}/parso-0.8.3/test/normalizer_issue_files/LICENSE %{buildroot}/usr/share/package-licenses/parso/f71a77bff7a0853ddf32ea962ef8582fe808d9f6
