...
Source0  : https://files.pythonhosted.org/packages/db/f4/f714d71a23b65d0be451131137152764e01e5f74607678cb8318a20d564a/parso-0.6.1.tar.gz
...
%prep
%setup -q -n parso-0.6.1
cd %{_builddir}/parso-0.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580879795
...
cp %{_builddir}/parso-0.6.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/parso/b1a7c6c0bf49fd5b62cca57a802166f291273c9a
cp %{_builddir}/parso-0.6.1/docs/_themes/flask/LICENSE %{buildroot}/usr/share/package-licenses/parso/d0eff60551064b040266867c393e035d747b0ae5
cp %{_builddir}/parso-0.6.1/test/normalizer_issue_files/LICENSE %{buildroot}/usr/share/package-licenses/parso/f71a77bff7a0853ddf32ea962ef8582fe808d9f6
